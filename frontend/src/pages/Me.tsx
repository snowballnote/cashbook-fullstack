    ...
    return (
        <div className="page">
            ...
            <div className="flex-1 bg-white rounded-lg p-5 shadow-sm">
                ...
                <button className="text-sm text-gray-600 underline" onClick={handleLogout}>
                로그아웃
                </button>
            </div>
            </div>
            ...
            <div className="flex-1 bg-white rounded-lg p-5 shadow-sm space-y-3">
                ...
                {msg && <p className="error-msg text-center">{msg}</p>}
            </div>
            </div>
            ...
            <div className="flex-1 bg-red-50 rounded-lg p-5">
